...
var accessLog = require('../handler/logHandler').logger({file:'access'});

function NotFound(msg) {
    this.name = 'NotFound';
    Error.call(this, msg);
    accessLog.error(null, msg);
    ...
    if (typeof line === "string") {
        ...
        if (info[1]) {
            ...
            if (posInfo.length >= 3){
                ...
                accessLog.error(null, 'failed to fetch stack info from this line: [' + line + ']');
                accessLog.error(null, e.stack);
            }
        }
    }
    return {};
